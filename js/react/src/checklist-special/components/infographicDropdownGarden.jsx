      ...
      >
        <div className="container mx-auto p-4">
          <div className="row" style={{ position: 'relative' }}>
            <div className="col">
              <h1 style={{ fontWeight: 'bold', width: '90%' }}>
              ...
              <h3 className={'w-90 will-collapse' + (this.state.isCollapsed ? ' is-collapsed' : '')}>
                Native plants thrive in Oregon’s unique landscapes and growing conditions, making them both beautiful
                and wise gardening choices. Use the tools below to find plants best suited to your tastes and your yard.
              </h3>
            </div>
