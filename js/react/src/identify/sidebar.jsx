...
class SidebarAccordion extends React.Component {
  ...
  render() {
    ...
    dropDownId = dropDownId
      .toLowerCase()
      .replace(/[^a-z]/g, '')
      .concat('-dropdown-body');

    return (
      <div className={'top-level' + (this.props.disabled === true ? ' dropdown-disabled' : '')}>
        <div className="row">
...
class SideBar extends React.Component {
  ...
  UNSAFE_componentWillReceiveProps() {
    //necessary because React doesn't set isMobile in componentDidMount grr
