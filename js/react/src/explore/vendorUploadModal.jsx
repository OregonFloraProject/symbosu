      ...
      <div className="modal-backdrop vendor-upload-modal">
        <div className="modal-content container mx-auto">
          <div className="wrapper vendor-upload-wrapper">
            <div
              className=""
              style={{ position: 'relative', minHeight: '45em', maxWidth: '100%', overflowX: 'hidden' }}
            >
                    ...
                    <div className="file-upload submit">
                      <div className="download-link">
                        {this.props.uploadResponse.csvURL && (
                          <div>
                            <span>I want to make edits</span>
                            <span>as a .csv file.</span>
                            <a href={this.props.uploadResponse.csvURL} download className="btn btn-primary">
                      ...
                      <div className="download-link">
                        {
                          <div>
                            ...
                            <a href={this.props.exportUrlCsv} download className="btn btn-primary">
                              Download
                            </a>
                          </div>
                        }
