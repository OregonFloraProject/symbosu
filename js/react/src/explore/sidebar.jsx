      ...
      <div id="sidebar" className="m-1 rounded-border" style={this.props.style}>
        <div className="currently-displayed">
          ...
          <div className="stat">
            ...
            <div className="stat-value">
              {this.props.totals['families']}
              {showFixedTotals && <span className="fixed-totals"> (of {this.props.fixedTotals['families']})</span>}
            </div>
          </div>
          <div className="stat">
            <div className="stat-label">Genera:</div>
            <div className="stat-value">
              {this.props.totals['genera']}
              {showFixedTotals && <span className="fixed-totals"> (of {this.props.fixedTotals['genera']})</span>}
            </div>
          </div>
          <div className="stat">
            <div className="stat-label">Species:</div>
            <div className="stat-value">
              {this.props.totals['species']}
              {showFixedTotals && <span className="fixed-totals"> (of {this.props.fixedTotals['species']})</span>}{' '}
              (species rank)
            </div>
          </div>
          <div className="stat">
            ...
            <div className="stat-value">
              {this.props.totals['taxa']}
              {showFixedTotals && <span className="fixed-totals"> (of {this.props.fixedTotals['taxa']})</span>}{' '}
          ...
          <div className="stat export">
            ...
            <div className="stat-value">
              <a
                className={'export-word' + (this.props.totals['taxa'] === 0 ? ' disabled' : '')}
              ...
              <a
                className={'export-csv' + (this.props.totals['taxa'] === 0 ? ' disabled' : '')}
                href={this.props.exportUrlCsv}
                title="Download CSV"
              >
        ...
        <div className="filter-tools">
          ...
          <div className="view-opts container row">
            <div className="row">
              ...
              <div className="opt-settings">
                <div className="view-opt-wrapper">
                  ...
                  />{' '}
                  <label className="" htmlFor={'searchname'}>
                    Scientific Names
                  </label>
                </div>
            ...
            <div className="row">
              <div className="opt-labels">Include:</div>
              <div className="opt-settings">
                <input
                  type="checkbox"
                  name={'searchSynonyms'}
                ...
                />
                <label className="ml-2 align-middle" htmlFor={'searchSynonyms'}>
                  {'Synonyms'}
                </label>
              </div>
            </div>
          ...
          <ViewOpts
            ...
            filters={Object.keys(this.props.filters).map((filterKey) => {
