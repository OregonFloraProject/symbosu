    ...
    return (
      <div className="wrapper">
        ...
        <div className="container explore" style={{ minHeight: '45em' }}>
            ...
            <div className="col-9 copy">
              {this.state.displayDescription == 'default' && (
                <div className="row title">
                  <div className="col-9">
                    <h2>
                      <span className="editable-content title-content">{this.state.title}</span>
                    </h2>
                  </div>
                  <div className="col-3">
              ...
              {this.state.displayDescription == 'expanded' && (
                <div>
                  <div className="row authors">
                    ...
                    <div className="col-10">
                      {this.state.isEditing['info'] == true ? (
                        ...
                        <span
                          className="editable-content authors-content"
                          dangerouslySetInnerHTML={{ __html: this.state.authors }}
                        />
                      )}
                    </div>
                  </div>
                  ...
                  <div className="row abstract">
                    ...
                    <div className="col-10">
                      {this.state.isEditing['info'] == true ? (
                        ...
                        <span
                          className="editable-content abstract-content"
                  ...
                  <div className="row locality">
                    ...
                    <div className="col-10">
                      {this.state.isEditing['info'] == true ? (
                        ...
                        <span
                          className="editable-content locality-content"
                          dangerouslySetInnerHTML={{ __html: this.state.locality }}
                        />
                      )}
                    </div>
                  </div>
                  ...
                  <div className="row publication">
                    ...
                    <div className="col-10">
                      {this.state.isEditing['info'] == true ? (
                        ...
                        <span
                          className="editable-content publication-content"
                          dangerouslySetInnerHTML={{ __html: this.state.publication }}
                        />
                      )}
                    </div>
                  </div>
                  ...
                  <div className="row notes">
                    ...
                    <div className="col-10">
                      {this.state.isEditing['info'] == true ? (
                        ...
                        <span
                          className="editable-content notes-content"
                    ...
                    <div className="col-10">
                      {this.state.isEditing['info'] == true ? (
                        <TextField
                          section="info"
                          name="latcentroid"
                          value={this.state.latcentroid}
                          onUpdate={this.updateField}
                          placeholder="Latitude"
                        />
                      ) : (
                        <span
                          className="editable-content latcentroid-content"
                          dangerouslySetInnerHTML={{ __html: this.state.latcentroid }}
                        />
                      )}
                    </div>
                  </div>
                    ...
                    <div className="col-10">
                      {this.state.isEditing['info'] == true ? (
                        <TextField
                          section="info"
                          name="longcentroid"
                          value={this.state.longcentroid}
                          onUpdate={this.updateField}
                          placeholder="Longitude"
                        />
                      ) : (
                        <span
                          className="editable-content longcentroid-content"
                          dangerouslySetInnerHTML={{ __html: this.state.longcentroid }}
                        />
                      )}
                    </div>
                  </div>
                  ...
                  <div className="row pointradiusmeters">
                    <div className="col-2">
                      <p>
                        <strong>Point Radius(meters): </strong>
                      </p>
                    </div>
                    <div className="col-10">
                      {this.state.isEditing['info'] == true ? (
                        <TextField
                          ...
                          value={this.state.pointradiusmeters}
                          onUpdate={this.updateField}
                          placeholder="Point Radius (meters)"
                        />
                      ) : (
                        <span
                          className="editable-content pointradiusmeters-content"
                          dangerouslySetInnerHTML={{ __html: this.state.pointradiusmeters }}
                        />
                      )}
                    </div>
                  </div>
              ...
              {this.state.googleMapUrl.length > 0 && (
                ...
                >
                  <img
                    ...
                    title="Project map"
                    alt="Map representation of checklists"
                  />
                </a>
              )}
            </div>
          ...
          <div className="row ">
            <a className="back-to-top mx-auto" onClick={() => window.scrollTo(0, 0)}>
