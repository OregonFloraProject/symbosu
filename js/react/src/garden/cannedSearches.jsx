    ...
    return (
      <div className={"py-2 canned-search-result"}>
        ...
        <div className="mt-2 px-2">
          <button className="w-100 px-3 my-1 btn-primary" onClick={this.props.onFilter}>
            Filter for these
          </button>
          <button className="w-100 px-3 my-1 btn-secondary" onClick={ () => { window.location = this.props.href } }>
            Learn more
          </button>
        </div>
      </div>
