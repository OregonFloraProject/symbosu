...
class GardenPageApp extends React.Component {
  ...
  componentDidMount() {
    ...
    Promise.all([cannedSearches, garden])
      .then((cres) => {
        let res = cres[1];
        let taxa = '';
        let tids = [];
                ...
                <div className="p-3 natives-credits">
                  <p>
                    <a href="https://www.oregonmetro.gov/" target="_blank" rel="noreferrer">
                      <img src={this.props.clientRoot + '/images/metro_logo_t.png'} className="metro" />
                    </a>
                  ...
                  <p>
                    <a
                      ...
                      rel="noreferrer"
                    >
                      <img src={this.props.clientRoot + '/images/nrcs-color-lockup-4x.png'} />
                    </a>
                  ...
                  <p>
                    See contributing partners to OregonFlora{' '}
                    <a href={this.props.clientRoot + '/pages/project-participants.php'}>here</a>.
                  </p>
                </div>
              </SideBar>
            </div>
...
ReactDOM.render(<GardenPageApp clientRoot={dataProps['clientRoot']} clid={54} pid={3} />, domContainer);
