    ...
    <div className="info-page">
      ...
      <section>
        <div className="inner-content mt-4">
          <p><a href={backToPage}><FontAwesomeIcon icon="chevron-left" /> Back</a></p>
          <h2>Access Policy</h2>
          ...
          <div className="py-4">
            {!shouldShowForm ? (
              isLoggedIn ?
                ...
                <a href={`${props.clientRoot}/profile/index.php?refurl=${encodeURIComponent(window.location.pathname + window.location.search)}`}>
