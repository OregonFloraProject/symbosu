...
function getIncludedHeritageLists(characteristics) {
  const heritageChar = characteristics.map(group => (
    Object.values(group.characters).find(char => char.cid === 244)
                  ...
                  <div id="view-opts" className="row">
                    <div className="col-7 button-section">
                      ...
                      <ViewOpts
                        ...
                        defaultMessage={ getDefaultSearchResultsMessage(this.state.searchResults.familySort.length, this.state.characteristics) }
                      />
