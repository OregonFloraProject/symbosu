      ...
      <div className={ "dashed-border pt-0 map-overlay-container" }>
        ...
        >
          ...
          <div className={`map-overlay-box${showOverlay ? '' : ' hidden'}`}>
            ...
            Access to detailed locality data limited. Please login to view interactive map or read our <a className="inner-link" href={`${props.clientRoot}/rare/policy.php`}>use policy</a>.
            </div>
          </div>
        </a>
			</div>
