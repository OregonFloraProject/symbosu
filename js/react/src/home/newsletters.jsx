      ...
      <div className="wrapper">
        ...
        <div className="container newsletters" style={{ minHeight: '45em' }}>
          <div className="row">
            <div className="col">
              <h2>
                Discover interviews with Oregon botanical notables, maps, taxonomy, and stories about the plants in our
                lives in our archives. The Oregon Flora Newsletter was published from 1995–2012.
              </h2>
            </div>
          </div>
          <div className="row">
            <div className="col">
              <p className="instructions">
                To download an issue, click on the PDF icon. To preview an issue’s contents, click the arrow.
              </p>
            </div>
          </div>
                      ...
                      <div className="issue-default">
                        <div className="issue-header">
                          <div className="issue-link">
                            <a href={'/ofn/' + issue[0].pdf + '.pdf'} target="_blank" rel="noreferrer">
                              <img src={`${this.props.clientRoot}/images/Adobe_PDF_file_icon_32x32.png`} />
                            </a>
                          </div>
                          <div className="issue-title">
                            <h3>{'Vol. ' + issue[0].volume + ' Iss. ' + issue[0].issue}</h3>
                          </div>
                        ...
                        {issue.map((article, idx) => {
                          return (
                            <div key={idx} className="row">
                              <div
                                className="issue-title col-sm-8 pr-0"
                                dangerouslySetInnerHTML={{ __html: article.title }}
                              ></div>
                              <div className="issue-author col-sm pl-0">{article.authors}</div>
                            </div>
                          );
                        })}
                      </div>
...
ReactDOM.render(<Newsletters clientRoot={dataProps['clientRoot']} />, domContainer);
