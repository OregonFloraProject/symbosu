...
<body>
	...
	<div id="innertext">
		...
		<p>Access each <a href="../collections/misc/collprofiles.php" target="_blank">collection profile page</a> to find the appropriate citation formats.</p>
		<h4>Example</h4>
		<blockquote>
			<?php
			$collData['collectionname'] = 'Oregon State University Vascular Plant Collection';
			$collData['dwcaurl'] = $serverHost . $CLIENT_ROOT . '/content/dwca/OSU-V_DwC-A.zip';
			$collData['recordid'] = 'be0e7675-e414-4e57-9ab8-cbd6c654c2e3';
