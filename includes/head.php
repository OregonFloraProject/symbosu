...
<link href="<?= $CSS_BASE_PATH ?>/symbiota/customizations.css?ver=<?php echo filemtime($SERVER_ROOT . '/css/symbiota/customizations.css'); ?>" type="text/css" rel="stylesheet">
