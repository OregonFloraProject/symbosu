...
<form name="reportsform" onsubmit="return ProcessReport();" method="post" target="_blank">
	<fieldset>
		...
		<button class="bottom-breathing-room-rel-sm" name="formsubmit" type="submit" onclick="this.form.action ='reports/<?php echo $invoice; ?>.php'" value="invoice"><?php echo $LANG['INVOICE']; ?></button>
		<?php
		if(isset($specimenTotal) && $specimenTotal){
			?>
			<button class="bottom-breathing-room-rel-sm" name="formsubmit" type="submit" onclick="this.form.action ='reports/<?php echo $speclist; ?>.php'" value="spec"><?php echo $LANG['SPEC_LIST']; ?></button>
			<?php
		}
		?>
		<button class="bottom-breathing-room-rel-sm" name="formsubmit" type="submit" onclick="this.form.action ='reports/<?php echo $mailinglabel; ?>.php'" value="label"><?php echo $LANG['MAILING_LABEL']; ?></button>
