		...
		<form name="speceditform" action="outgoing.php" method="post" onsubmit="return verifySpecEditForm(this)" >
			<div id="newdet-div" style="display:none;">
				<fieldset>
					...
					<div style='margin:3px;'>
						<b><?php echo (defined('SCIENTIFICNAMEAUTHORSHIPLABEL')?SCIENTIFICNAMEAUTHORSHIPLABEL:$LANG['AUTHOR']); ?>:</b>
						<input type="text" name="scientificnameauthorship" style="width:200px;" />
					</div>
					<div style='margin:3px;'>
						<b><?php echo (defined('IDCONFIDENCELABEL')?IDCONFIDENCELABEL:$LANG['CONFIDENCE_IN_DET']); ?>:</b>
					...
					<div style='margin:3px;'>
						<b><?php echo (defined('IDENTIFICATIONREMARKSLABEL')?IDENTIFICATIONREMARKSLABEL:$LANG['NOTES']); ?>:</b>
			...
			<table class="styledtable" style="font-size:12px;">
				<tr>
					...
					<th>&nbsp;</th>
					<th><?php echo (defined('CATALOGNUMBERLABEL')?CATALOGNUMBERLABEL:$LANG['CATNO']); ?>
					<?php
