								...
								<form id="fullform" name="fullform" action="occurrenceeditor.php" method="post" onsubmit="return verifyFullForm(this);">
									...
									<fieldset>
										...
										if($LOCALITY_AUTO_LOOKUP){
											?>
											<div id="localAutoDeactivatedDiv" title="<?php= (defined('LOCALITYAUTOLOOKUPTIP') ? LOCALITYAUTOLOOKUPTIP : ''); ?>">
										...
										<div id="localSecurityDiv" title="<?php echo (defined('LOCALITYSECURITYTIP') ? LOCALITYSECURITYTIP : ''); ?>">
											<div style="float:left;">
												<?php
												echo (defined('RECORDSECURITYLABEL')?RECORDSECURITYLABEL:$LANG['SECURITY']);
											...
											<div id="locsecreason" style="margin-left:5px;border:2px solid gray;float:left;display:<?= ($lsrValue||$securityCode?'inline':'none') ?>;padding:3px"  title="<?php echo (defined('LOCALITYSECURITYREASONTIP') ? LOCALITYSECURITYREASONTIP : ''); ?>">
												...
												<?= (defined('SECURITYREASONLABEL')?SECURITYREASONLABEL:$LANG['SECURITY_REASON']) ?>:
										...
										<div style="clear:both;" class="fieldGroup-div">
											<span id="coordinateWrapper" onchange="coordinatesChanged(document.getElementById('fullform'), '<?= $CLIENT_ROOT?>')">
												<div id="decimalLatitudeDiv" class="field-div" title="<?php echo (defined('DECIMALLATITUDETIP') ? DECIMALLATITUDETIP : ''); ?>">
													<?= (defined('DECIMALLATITUDELABEL')?DECIMALLATITUDELABEL:$LANG['DECIMAL_LATITUDE']) ?>
													<br/>
													<?php
													$latValue = '';
												...
												<div id="decimalLongitudeDiv" class="field-div"  title="<?php echo (defined('DECIMALLONGITUDETIP') ? DECIMALLONGITUDETIP : ''); ?>">
													<?= (defined('DECIMALLONGITUDELABEL')?DECIMALLONGITUDELABEL:$LANG['DECIMAL_LONGITUDE']) ?>
													<br/>
													<?php
													$longValue = "";
											...
											<div id="mapIconDiv" title="<?= (defined('MAPSTIP') ? MAPSTIP : $LANG['MAP_COORDS']) ?>">
									...
									<fieldset>
										...
										<div id="associatedTaxaDiv" class="field-div" title="<?php echo (defined('ASSOCIATEDTAXATIP') ? ASSOCIATEDTAXATIP : ''); ?>">
											...
											if(!isset($ACTIVATEASSOCTAXAAID) || $ACTIVATEASSOCTAXAAID){
												echo '<a href="#" onclick="openAssocSppAid();return false;" title="'.(defined('ASSOCIATEDTAXAAIDTIP') ? ASSOCIATEDTAXAAIDTIP : '').'" aria-label="'.(isset($LANG['ASSOC_SPP_AID']) ? $LANG['ASSOC_SPP_AID'] . $LANG['OPENS_NEW_TAB'] : 'Associated Species Entry Aid (opens in new tab)').'"><img class="editimg" src="../../images/list.png"></a>';
											}
											?>
										</div>
									...
									<fieldset>
										...
										<div style="padding:3px;clear:both;">
											...
											<div id="processingStatusDiv" class="field-div" title="<?php echo (defined('PROCESSINGSTATUSTIP') ? PROCESSINGSTATUSTIP : ''); ?>">
												<?php echo (defined('PROCESSINGSTATUSLABEL')?PROCESSINGSTATUSLABEL:$LANG['PROCESSING_STATUS']); ?>
											...
											<div id="dataGeneralizationsDiv" class="field-div" title="<?php echo (defined('DATAGENERALIZATIONSTIP') ? DATAGENERALIZATIONSTIP : $LANG['AKA_GENERAL']); ?>">
												<?php echo (defined('DATAGENERALIZATIONSLABEL')?DATAGENERALIZATIONSLABEL:$LANG['DATA_GENERALIZATIONS']); ?>
