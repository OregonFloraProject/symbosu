								...
								<form id="fullform" name="fullform" action="occurrenceeditor.php" method="post" onsubmit="return verifyFullForm(this);">
									<fieldset>
										...
										<div style="clear:both;">
											<div id="catalogNumberDiv" class="field-div" title="<?php echo (defined('CATALOGNUMBERTIP') ? CATALOGNUMBERTIP : ''); ?>">
											...
											<div id="otherCatalogNumbersDiv" class="field-div" title="<?php echo (defined('OTHERCATALOGNUMBERSTIP') ? OTHERCATALOGNUMBERSTIP : ''); ?>">
										...
										<div style="clear:both;">
											<div id="recordedByDiv" class="field-div" title="<?php echo (defined('RECORDEDBYTIP') ? RECORDEDBYTIP : ''); ?>">
											...
											<div id="recordNumberDiv" class="field-div" title="<?php echo (defined('RECORDNUMBERTIP') ? RECORDNUMBERTIP : ''); ?>">
											...
											<div id="eventDateDiv" class="field-div" title="<?php echo (defined('EVENTDATETIP') ? EVENTDATETIP : 'Earliest Date Collected'); ?>">
										...
										<div style="clear:both;">
											<div id="associatedCollectorsDiv" class="field-div" title="<?php echo (defined('ASSOCIATEDCOLLECTORSTIP') ? ASSOCIATEDCOLLECTORSTIP : ''); ?>">
												<div class="flabel">
											...
											<div id="verbatimEventDateDiv" class="field-div" title="<?php echo (defined('VERBATIMEVENTDATETIP') ? VERBATIMEVENTDATETIP : ''); ?>">
												<div class="flabel">
													<?php echo (defined('VERBATIMEVENTDATELABEL')?VERBATIMEVENTDATELABEL:$LANG['VERBATIM_EVENT_DATE']); ?>
										...
										if(isset($ACTIVATE_EXSICCATI) && $ACTIVATE_EXSICCATI){
											...
											?>
											<div id="exsDiv">
												<div id="ometidDiv" class="field-div" title="<?php echo (defined('EXSICCATITITLETIP') ? EXSICCATITITLETIP : ''); ?>">
												...
												<div id="exsnumberDiv" class="field-div" title="<?php echo (defined('EXSICCATINUMBERTIP') ? EXSICCATINUMBERTIP : ''); ?>">
									...
									<fieldset>
										...
										<div style="clear:both;">
											<div id="scinameDiv" class="field-div" title="<?php echo (defined('SCIENTIFICNAMETIP') ? SCIENTIFICNAMETIP : ''); ?>">
												<?php echo (defined('SCIENTIFICNAMELABEL')?SCIENTIFICNAMELABEL:$LANG['SCINAME']); ?>
										...
										<div style="clear:both;padding:3px 0px 0px 10px;">
											...
											if(!$occId){
												...
												echo (defined('IDCONFIDENCELABEL')?IDCONFIDENCELABEL:$LANG['IDENTIFICATION_CONFIDENCE']);
											...
											?>
											<div id="identificationQualifierDiv" class="field-div" title="<?php echo (defined('IDENTIFICATIONQUALIFIERTIP') ? IDENTIFICATIONQUALIFIERTIP : 'e.g. cf, aff, etc'); ?>">
										...
										<div style="clear:both;padding:3px 0px 0px 10px;">
											<div id="identifiedByDiv" class="field-div" title="<?php echo (defined('IDENTIFIEDBYTIP') ? IDENTIFIEDBYTIP : ''); ?>">
											...
											<div id="dateIdentifiedDiv" class="field-div" title="<?php echo (defined('DATEIDENTIFIEDTIP') ? DATEIDENTIFIEDTIP : ''); ?>">
										...
										<div  id="idrefdiv" >
											<div id="identificationReferencesDiv" class="field-div" title="<?php echo (defined('IDENTIFICATIONREFERENCETIP') ? IDENTIFICATIONREFERENCETIP : ''); ?>">
											...
											<div id="identificationRemarksDiv" class="field-div" title="<?php echo (defined('IDENTIFICATIONREMARKSTIP') ? IDENTIFICATIONREMARKSTIP : ''); ?>">
											...
											<div id="taxonRemarksDiv" class="field-div" title="<?php echo (defined('TAXONREMARKSTIP') ? TAXONREMARKSTIP : ''); ?>">
									...
									<fieldset>
										...
										<div id="geography1-div" class="fieldGroup-div" style="<?= ($displayGeo1Div ? 'display:flex' : 'display:none') ?>">
											<div id="continentDiv" class="field-div" title="<?php echo (defined('CONTINENTTIP') ? CONTINENTTIP : ''); ?>">
												<?= (defined('CONTINENTLABEL')?CONTINENTLABEL:$LANG['CONTINENT']); ?>
											...
											<div id="waterBodyDiv" class="field-div" title="<?php echo (defined('WATERBODYTIP') ? WATERBODYTIP : ''); ?>">
												<?= (defined('WATERBODYLABEL')?WATERBODYLABEL:$LANG['WATER_BODY']); ?>
											...
											<div id="islandGroupDiv" class="field-div" title="<?php echo (defined('ISLANDGROUPTIP') ? ISLANDGROUPTIP : ''); ?>">
												<?= (defined('ISLANDGROUPLABEL')?ISLANDGROUPLABEL:$LANG['ISLAND_GROUP']); ?>
											...
											<div id="islandDiv" class="field-div" title="<?php echo (defined('ISLANDTIP') ? ISLANDTIP : ''); ?>">
												<?= (defined('ISLANDLABEL')?ISLANDLABEL:$LANG['ISLAND']); ?>
										...
										<div class="fieldGroup-div">
											<div id="countryDiv" class="field-div" title="<?php echo (defined('COUNTRYTIP') ? COUNTRYTIP : ''); ?>">
											...
											<div id="stateProvinceDiv" class="field-div" title="<?php echo (defined('STATEPROVINCETIP') ? STATEPROVINCETIP : ''); ?>">
												<?php echo (defined('STATEPROVINCELABEL')?STATEPROVINCELABEL:$LANG['STATEPROVINCE']); ?>
											...
											<div id="countyDiv" class="field-div" title="<?php echo (defined('COUNTYTIP') ? COUNTYTIP : ''); ?>">
											...
											<div id="municipalityDiv" class="field-div" title="<?php echo (defined('MUNICIPALITYTIP') ? MUNICIPALITYTIP : ''); ?>">
											...
											<div id="locationIdDiv" class="field-div" title="<?php echo (defined('LOCATIONIDTIP') ? LOCATIONIDTIP : ''); ?>">
										...
										<div id="localityDiv" class="fieldGroup-div" title="<?php echo (defined('LOCALITYTIP') ? LOCALITYTIP : ''); ?>">
										...
										?>
										<div id="localSecurityDiv" title="<?php echo (defined('LOCALITYSECURITYTIP') ? LOCALITYSECURITYTIP : ''); ?>">
											<div style="float:left;">
												<?php
												echo (defined('LOCALITYSECURITYLABEL')?LOCALITYSECURITYLABEL:$LANG['LOCALITY_SECURITY']);
											...
											<div id="locsecreason" style="margin-left:5px;border:2px solid gray;float:left;display:<?php echo ($lsrValue||$securityCode?'inline':'none') ?>;padding:3px" title="<?php echo (defined('LOCALITYSECURITYREASONTIP') ? LOCALITYSECURITYREASONTIP : ''); ?>">
												...
												<?= (defined('LOCALITYSECURITYREASONLABEL')?LOCALITYSECURITYREASONLABEL:$LANG['LOCALITY_SECURITY_REASON']); ?>:
										...
										<div style="clear:both;" class="fieldGroup-div">
											<div id="decimalLatitudeDiv" class="field-div" title="<?php echo (defined('DECIMALLATITUDETIP') ? DECIMALLATITUDETIP : ''); ?>">
											...
											<div id="decimalLongitudeDiv" class="field-div" title="<?php echo (defined('DECIMALLONGITUDETIP') ? DECIMALLONGITUDETIP : ''); ?>">
											...
											<div id="coordinateUncertaintyInMetersDiv" class="field-div" title="<?php echo (defined('COORDINATEUNCERTAINITYINMETERSTIP') ? COORDINATEUNCERTAINITYINMETERSTIP : ''); ?>">
												<?php echo (defined('COORDINATEUNCERTAINITYINMETERSLABEL')?COORDINATEUNCERTAINITYINMETERSLABEL:$LANG['COORDINATE_UNCERTAINITY_IN_METERS']); ?>
											...
											<div id="mapIconDiv" onclick="openMappingAid();" title="<?= (defined('MAPSTIP') ? MAPSTIP : $LANG['MAP_COORDS']); ?>">
											...
											<div id="geodeticDatumDiv" class="field-div" title="<?php echo (defined('GEODETICDATUMTIP') ? GEODETICDATUMTIP : ''); ?>">
												<?php echo (defined('GEODETICDATUMLABEL')?GEODETICDATUMLABEL:$LANG['GEODETIC_DATUM']); ?>
											...
											<div id="verbatimCoordinatesDiv" class="field-div" title="<?php echo (defined('VERBATIMCOORDINATESTIP') ? VERBATIMCOORDINATESTIP : ''); ?>">
										...
										<div style="clear:both;">
											<div id="elevationDiv" class="field-div" title="<?php echo (defined('ELEVATIONINMETERSTIP') ? ELEVATIONINMETERSTIP : ''); ?>">
												...
												<br/>
												<input type="text" name="minimumelevationinmeters" maxlength="6" value="<?php echo array_key_exists('minimumelevationinmeters',$occArr)?$occArr['minimumelevationinmeters']:''; ?>" onchange="minimumElevationInMetersChanged(this.form);" title="<?php echo (defined('MINELEVATIONINMETERSTIP') ? MINELEVATIONINMETERSTIP :(isset($LANG['MIN_ELEVATION'])?$LANG['MIN_ELEVATION']:'Minimum Elevation in Meters')); ?>" /> -
												<input type="text" name="maximumelevationinmeters" maxlength="6" value="<?php echo array_key_exists('maximumelevationinmeters',$occArr)?$occArr['maximumelevationinmeters']:''; ?>" onchange="maximumElevationInMetersChanged(this.form);" title="<?php echo (defined('MAXELEVATIONINMETERSTIP') ? MAXELEVATIONINMETERSTIP :(isset($LANG['MAX_ELEVATION'])?$LANG['MAX_ELEVATION']:'Maximum Elevation in Meters')); ?>" />
											</div>
											<div id="verbatimElevationDiv" class="field-div" title="<?php echo (defined('VERBATIMELEVATIONTIP') ? VERBATIMELEVATIONTIP : ''); ?>">
											...
											<div id="depthDiv" class="field-div" title="<?php echo (defined('DEPTHINMETERSTIP') ? DEPTHINMETERSTIP : ''); ?>">
												...
												<br/>
												<input type="text" name="minimumdepthinmeters" maxlength="6" value="<?php echo array_key_exists('minimumdepthinmeters',$occArr)?$occArr['minimumdepthinmeters']:''; ?>" onchange="minimumDepthInMetersChanged(this.form);" title="<?php echo (defined('MINDEPTHINMETERSTIP') ? MINDEPTHINMETERSTIP : $LANG['MIN_DEPTH']); ?>" /> -
												<input type="text" name="maximumdepthinmeters" maxlength="6" value="<?php echo array_key_exists('maximumdepthinmeters',$occArr)?$occArr['maximumdepthinmeters']:''; ?>" onchange="maximumDepthInMetersChanged(this.form);" title="<?php echo (defined('MAXDEPTHINMETERSTIP') ? MAXDEPTHINMETERSTIP : $LANG['MAX_DEPTH']); ?>" />
											</div>
											<div id="verbatimDepthDiv" class="field-div" title="<?php echo (defined('VERBATIMDEPTHTIP') ? VERBATIMDEPTHTIP : ''); ?>">
												<div style="float:left;">
										...
										<div id="georefExtraDiv" style="<?php echo $georefExtraDiv; ?>;">
											<div style="clear:both;">
												<div id="georeferencedByDiv" class="field-div" title="<?php echo (defined('GEOREFERENCEBYTIP') ? GEOREFERENCEBYTIP : ''); ?>">
												...
												<div id="georeferenceSourcesDiv" class="field-div" title="<?php echo (defined('GEOREFERENCESOURCESTIP') ? GEOREFERENCESOURCESTIP : ''); ?>">
												...
												<div id="georeferenceRemarksDiv" class="field-div" title="<?php echo (defined('GEOREFERENCEREMARKSTIP') ? GEOREFERENCEREMARKSTIP : ''); ?>">
											...
											<div style="clear:both;">
												<div id="georeferenceProtocolDiv" class="field-div" title="<?php echo (defined('GEOREFERENCEPROTOCOLTIP') ? GEOREFERENCEPROTOCOLTIP : ''); ?>">
												...
												<div id="georeferenceVerificationStatusDiv" class="field-div" title="<?php echo (defined('GEOREFERENCEVERIFICATIONSTATUSTIP') ? GEOREFERENCEVERIFICATIONSTATUSTIP : ''); ?>">
												...
												<div id="footprintWktDiv" class="field-div" title="<?php echo (defined('FOOTPRINTWKTTIP') ? FOOTPRINTWKTTIP : ''); ?>">
													<?php echo (defined('FOOTPRINTWKTLABEL')?FOOTPRINTWKTLABEL:$LANG['FOOTPRINT_WKT']); ?>
													<br/>
									...
									<fieldset>
										...
										<div id="habitatDiv" class="field-div" title="<?php echo (defined('HABITATTIP') ? HABITATTIP : ''); ?>">
										...
										<div id="substrateDiv" class="field-div" title="<?php echo (defined('SUBSTRATETIP') ? SUBSTRATETIP : ''); ?>">
										...
										if(!empty($QUICK_HOST_ENTRY_IS_ACTIVE)) { // Quick host field
											...
											?>
											<div id="hostDiv" class="field-div" title="<?php echo (defined('HOSTTIP') ? HOSTTIP : ''); ?>">
										...
										?>
										<div id="associatedTaxaDiv" class="field-div" title="<?php echo (defined('ASSOCIATEDTAXATIP') ? ASSOCIATEDTAXATIP : ''); ?>">
										...
										<div id="verbatimAttributesDiv" class="field-div" title="<?php echo (defined('VERBATIMATTRIBUTESTIP') ? VERBATIMATTRIBUTESTIP : ''); ?>">
										...
										<div id="occurrenceRemarksDiv" class="field-div" title="<?php echo (defined('OCCURRENCEREMARKSTIP') ? OCCURRENCEREMARKSTIP : ''); ?>">
										...
										<div id="dynamicPropertiesDiv" class="field-div" style="display:<?= empty($occArr['dynamicproperties']) ? 'none' : '' ?>" title="<?php echo (defined('DYNAMICPROPERTIESTIP') ? DYNAMICPROPERTIESTIP : ''); ?>">
										...
										<div style="padding:2px;">
											<div id="lifeStageDiv" class="field-div" title="<?php echo (defined('LIFESTAGETIP') ? LIFESTAGETIP : ''); ?>">
											...
											<div id="sexDiv" class="field-div" title="<?php echo (defined('SEXTIP') ? SEXTIP : ''); ?>">
											...
											<div id="individualCountDiv" class="field-div" title="<?php echo (defined('INDIVIDUALCOUNTTIP') ? INDIVIDUALCOUNTTIP : ''); ?>">
											...
											<div id="samplingProtocolDiv" class="field-div" title="<?php echo (defined('SAMPLINGPROTOCOLTIP') ? SAMPLINGPROTOCOLTIP : ''); ?>">
											...
											<div id="preparationsDiv" class="field-div" title="<?php echo (defined('PREPARATIONSTIP') ? PREPARATIONSTIP : ''); ?>">
											...
											<div id="reproductiveConditionDiv" class="field-div" title="<?php echo (defined('REPRODUCTIVECONDITIONTIP') ? REPRODUCTIVECONDITIONTIP : ''); ?>">
											...
											<div id="behaviorDiv" class="field-div" title="<?php echo (defined('BEHAVIORTIP') ? BEHAVIORTIP : ''); ?>">
												<?= (defined('BEHAVIORLABEL')?BEHAVIORLABEL:$LANG['BEHAVIOR']); ?>
											...
											<div id="vitalityDiv" class="field-div" title="<?php echo (defined('VITALITYTIP') ? VITALITYTIP : ''); ?>">
												<?= (defined('VITALITYLABEL')?VITALITYLABEL:$LANG['VITALITY']); ?>
											...
											<div id="establishmentMeansDiv" class="field-div" title="<?php echo (defined('ESTABLISHMENTMEANSTIP') ? ESTABLISHMENTMEANSTIP : ''); ?>">
											...
											<div>
											<div id="cultivationStatusDiv" class="field-div" title="<?php echo (defined('CULTIVATIONSTATUSTIP') ? CULTIVATIONSTATUSTIP : ''); ?>">
									...
									<fieldset>
										...
										<div style="padding:3px;clear:both;">
											<div id="typeStatusDiv" class="field-div" title="<?php echo (defined('TYPESTATUSTIP') ? TYPESTATUSTIP : ''); ?>">
											...
											<div id="dispositionDiv" class="field-div" title="<?php echo (defined('DISPOSITIONTIP') ? DISPOSITIONTIP : ''); ?>">
											...
											<div id="occurrenceIdDiv" class="field-div" title="<?php echo (defined('OCCURRENCEIDTIP') ? OCCURRENCEIDTIP : 'If different than institution code'); ?>">
											...
											<div id="fieldNumberDiv" class="field-div" title="<?php echo (defined('FIELDNUMBERTIP') ? FIELDNUMBERTIP : 'An identifier given to the collecting event in the field'); ?>">
											...
											<div id="languageDiv" class="field-div" title="<?php echo (defined('LANGUAGETIP') ? LANGUAGETIP : ''); ?>">
												<?php echo (defined('LANGUAGELABEL')?LANGUAGELABEL:$LANG['LANGUAGE']); ?>
											...
											<div id="labelProjectDiv" class="field-div" title="<?php echo (defined('LABELPROJECTTIP') ? LABELPROJECTTIP : ''); ?>">
												<?php echo (defined('LABELPROJECTLABEL')?LABELPROJECTLABEL:$LANG['LABEL_PROJECT']); ?>
											...
											<div id="duplicateQuantityDiv" class="field-div" title="<?php echo (defined('DUPLICATEQUANTITYTIP') ? DUPLICATEQUANTITYTIP : 'aka label quantity'); ?>">
												<?php echo (defined('DUPLICATEQUALITYLABEL')?DUPLICATEQUALITYLABEL:$LANG['DUPLICATE_COUNT']); ?>
										...
										<div style="padding:3px;clear:both;">
											<div id="institutionCodeDiv" class="field-div" title="<?php echo (defined('INSTITUTIONCODETIP') ? INSTITUTIONCODETIP : $LANG['INST_CODE_EXPLAIN']); ?>">
											...
											<div id="collectionCodeDiv" class="field-div" title="<?php echo (defined('COLLECTIONCODETIP') ? COLLECTIONCODETIP : $LANG['COLL_CODE_EXPLAIN']); ?>">
											...
											<div id="ownerInstitutionCodeDiv" class="field-div" title="<?php echo (defined('OWNERINSTITUTIONCODETIP') ? OWNERINSTITUTIONCODETIP : $LANG['OWNER_CODE_EXPLAIN']); ?>">
											...
											<div id="basisOfRecordDiv" class="field-div" title="<?php echo (defined('BASISOFRECORDTIP') ? BASISOFRECORDTIP : ''); ?>">
											...
											<div id="processingStatusDiv" class="field-div" title="<?php echo (defined('PROCESSINGSTATUSTIP') ? PROCESSINGSTATUSTIP : ''); ?>">
											...
											<div id="dataGeneralizationsDiv" class="field-div" title="<?php echo (defined('DATAGENERALIZATIONSTIP') ? DATAGENERALIZATIONSTIP : $LANG['AKA_GENERAL']); ?>">
											...
											if($isEditor == 1 || $isEditor == 2){
												...
												<div id="cloneDiv" style="float:right;">
													<fieldset class="optionBox">
														...
														<div class="fieldGroup-div" title="<?php echo (defined('CARRYOVERTIP') ? CARRYOVERTIP : ''); ?>">
														...
														<div class="fieldGroup-div" title="<?php echo (defined('RELATIONSHIPTIP') ? RELATIONSHIPTIP : 'Relationship to this occurrence'); ?>">
														...
														if(count($targetArr) > 1){
															?>
															<div class="fieldGroup-div" title="<?php echo (defined('TARGETCOLLECTIONTIP') ? TARGETCOLLECTIONTIP : ''); ?>">
														...
														?>
														<div class="fieldGroup-div" title="<?php echo (defined('NUMBERRECORDSTIP') ? NUMBERRECORDSTIP : ''); ?>">
															<label><?php echo $LANG['NUMBER_RECORDS']; ?>:</label> <input id="clonecount" name="clonecount" type="text" value="1" style="width:40px" />
														</div>
														<div class="fieldGroup-div" title="<?php echo (defined('PREPOPULATETIP') ? PREPOPULATETIP : ''); ?>">
															<a href="#" onclick="return prePopulateCatalogNumbers();"><?php echo htmlspecialchars($LANG['PRE_POPULATE'], ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE); ?></a>
														</div>
														<fieldset id="cloneCatalogNumber-Fieldset" style="display:none">
															<div id="cloneCatalogNumberDiv" class="fieldGroup-div" title="<?php echo (defined('CLONECATALOGNUMBERTIP') ? CLONECATALOGNUMBERTIP : ''); ?>"></div>
														</fieldset>
