...
'delete record', 'duplicate specimen', // Specific to BAKER
'pull specimen', 're-image', 'specimen pulled', // Problems
'merge duplicate', 'reviewed', "vouchervision qc", // Main workflow
'expert required', 'curator', // Quality Control
'unprocessed', 'label transcription', 'coge', 'quality control', // Admin
'pending review', 'closed', 'pending review-nfn', 'unprocessed/NLP', 'stage 1', 'stage 2', 'stage 3']; // Unused Symbiota defaults
