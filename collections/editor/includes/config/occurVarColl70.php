...
const PROCESSINGSTATUS = ['unprocessed','label transcription','skeletal entry','expert required','pending review','reviewed','closed','curator','quality control','unprocessed/NLP','stage 1','stage 2','stage 3','pending review-nfn', 'unaccessioned'];
...
define('LOCALITYAUTOLOOKUPTIP','Unless deactivated, when you type in a locality, it will try to autocomplete with previously entered localities that also match the collector, collector number and date. If you select one of those matches, it will fill in any associated data (lat/long, elevation, habitat, etc.)');
