			...
			<form id='imgoccurform' name='imgoccurform' action='imageoccursubmit.php' method='post' enctype='multipart/form-data' onsubmit="return validateImgOccurForm(this)">
				...
				<fieldset style="padding:15px;">
					...
					<div style="margin:3px;" title="<?php echo (defined('CATALOGNUMBERTIP') ? CATALOGNUMBERTIP : ''); ?>">
						<label for="catalognumber"> <b> <?php echo (defined('CATALOGNUMBERLABEL') ? CATALOGNUMBERLABEL : (isset($LANG['CAT_NUM']) ? $LANG['CAT_NUM'] : 'Catalog Number')); ?>:</b> </label>
					...
					<div style="margin:3px;">
						<div style="display: inline;" title="<?php echo (defined('SCIENTIFICNAMETIP') ? SCIENTIFICNAMETIP : ''); ?>">
							<label for="sciname"> <b><?php echo (defined('SCIENTIFICNAMELABEL') ? SCIENTIFICNAMELABEL : (isset($LANG['SCINAME']) ? $LANG['SCINAME'] : 'Scientific Name')); ?>:</b> </label>
						...
						<div style="display: inline;" title="<?php echo (defined('SCIENTIFICNAMEAUTHORSHIPTIP') ? SCIENTIFICNAMEAUTHORSHIPTIP : ''); ?>">
							<input name="scientificnameauthorship" type="text" value="<?php echo (isset($_POST['scientificnameauthorship']) ? $_POST['scientificnameauthorship'] : ''); ?>" aria-label="<?php echo (defined('SCIENTIFICNAMEAUTHORSHIPLABEL') ? SCIENTIFICNAMEAUTHORSHIPLABEL : (isset($LANG['AUTHOR']) ? $LANG['AUTHOR'] : 'Scientific Name Authorship'));?>" /><br/>
						</div>
						...
						<div title="<?php echo (defined('FAMILYTIP') ? FAMILYTIP : ''); ?>">
							<label for="family"> <b><?php echo (defined('FAMILYLABEL') ? FAMILYLABEL : (isset($LANG['FAMILY']) ? $LANG['FAMILY'] : 'Family')); ?>:</b> </label>
					...
					<div>
						<div style="float:left;margin:3px;" title="<?php echo (defined('COUNTRYTIP') ? COUNTRYTIP : ''); ?>">
							<label for="country"><b><?php echo (defined('COUNTRYLABEL') ? COUNTRYLABEL : (isset($LANG['COUNTRY']) ? $LANG['COUNTRY'] : 'Country'));?>:</b><br/> </label>
						...
						<label for="state"><b><?php echo (defined('STATEPROVINCELABEL') ? STATEPROVINCELABEL : (isset($LANG['STATE_PROVINCE']) ? $LANG['STATE_PROVINCE'] : 'State/Province')); ?>:</b><br/> </label>
						...
						<label for="county"><b><?php echo (defined('COUNTYLABEL') ? COUNTYLABEL : (isset($LANG['COUNTY']) ? $LANG['COUNTY'] : 'County')); ?>:</b><br/> </label>
