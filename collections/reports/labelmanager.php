...
<html lang="<?php echo $LANG_TAG ?>">
	...
	<div role="main" id="innertext">
		...
		if($isEditor){
			...
			if(is_writable($TEMP_DIR_ROOT.'/report')) $reportsWritable = true;
			if(!$reportsWritable){
				?>
					...
					<fieldset>
						...
						<div style="margin:3px;">
							<div title="<?php echo (isset($LANG['DEF_SPEC_REC']) ? $LANG['DEF_SPEC_REC'] : 'Scientific name as entered in database.') ?>">
								<label for="taxa"> <?php echo (defined('SCIENTIFICNAMELABEL')?SCIENTIFICNAMELABEL: (isset($LANG['SCI_NAME']) ? $LANG['SCI_NAME'] : 'Scientific Name: ')) ?></label>
						...
						<div style="margin:3px;clear:both;">
							<div style="float:left;" title="<?php echo (isset($LANG['FULL_NAME']) ? $LANG['FULL_NAME'] : 'Full or last name of collector as entered in database.') ?>">
								<label for="recordedby"><?php echo (defined('RECORDEDBYLABEL')?RECORDEDBYLABEL: (isset($LANG['COLLECTOR']) ? $LANG['COLLECTOR'] : 'Collector:')) ?></label>
							...
							<div style="float:left;margin-left:20px;" title="<?php echo (isset($LANG['SEPARATE_TERMS']) ? $LANG['SEPARATE_TERMS'] : 'Separate multiple terms by comma and ranges by \' - \' (space before and after dash required), e.g.: 3542,3602,3700 - 3750') ?>">
								<label for="recordnumber"><?php echo (defined('RECORDNUMBERLABEL')?RECORDNUMBERLABEL: (isset($LANG['REC_NUM']) ? $LANG['REC_NUM'] : 'Record Number(s):')) ?></label>
							...
							<div style="float:left;margin-left:20px;" title="<?php echo (isset($LANG['SEPARATE_TERMS']) ? $LANG['SEPARATE_TERMS'] : 'Separate multiple terms by comma and ranges by \' - \' (space before and after dash required), e.g.: 3542,3602,3700 - 3750') ?>">
								<label for="identifier"><?php echo (defined('CATALOGNUMBERLABEL')?CATALOGNUMBERLABEL: (isset($LANG['CAT_NUM']) ? $LANG['CAT_NUM'] : 'Catalog Number(s):')) ?></label>
						...
						<div style="margin:3px;clear:both;">
							<label for="labelproject"> <?php echo (defined('LABELPROJECTLABEL')?LABELPROJECTLABEL: (isset($LANG['LABEL_PROJ']) ? $LANG['LABEL_PROJ'] : 'Label Projects:')) ?></label>
							...
							<form name="selectform" id="selectform" action="labeldynamic.php" method="post" onsubmit="return validateSelectForm(this);">
								<table class="styledtable" style="font-size:12px;">
									<tr>
										...
										<th> <?php echo (defined('RECORDEDBYLABEL')?RECORDEDBYLABEL: (isset($LANG['COLLECTOR']) ? $LANG['COLLECTOR'] : 'Collector')) ?> </th>
										<th> <?php echo (defined('SCIENTIFICNAMELABEL')?SCIENTIFICNAMELABEL: (isset($LANG['SCI_NAME']) ? $LANG['SCI_NAME'] : ' Scientific Name')) ?></th>
										<th> <?php echo (defined('LOCALITYLABEL')?LOCALITYLABEL: (isset($LANG['LOCALITY']) ? $LANG['LOCALITY'] : 'Locality')) ?></th>
									</tr>
									<?php
									$trCnt = 0;
								...
								<fieldset style="margin-top:15px;">
									...
									<div class="fieldDiv">
										...
										<div class="fieldElement">
											<input type="radio" id="hmid1" name="hmid" value="1" /> <?php echo (defined('COUNTRYLABEL')?COUNTRYLABEL: (isset($LANG['COUNTRY']) ? $LANG['COUNTRY'] : 'Country')) ?>
											<input type="radio" id="hmid2" name="hmid" value="2" /> <?php echo (defined('STATEPROVINCELABEL')?STATEPROVINCELABEL: (isset($LANG['STATE']) ? $LANG['STATE'] : 'State')) ?>
											<input type="radio" id="hmid3" name="hmid" value="3" /> <?php echo (defined('COUNTYLABEL')?COUNTYLABEL: (isset($LANG['COUNTY']) ? $LANG['COUNTY'] : 'County')) ?>
											<input type="radio" id="hmid4" name="hmid" value="4" /> <?php echo (defined('FAMILYLABEL')?FAMILYLABEL: (isset($LANG['FAMILY']) ? $LANG['FAMILY'] : 'Family')) ?>
									...
									<div class="fieldDiv">
										...
										<span class="checkboxLabel"><?php echo (defined('CATALOGNUMBERLABEL')?'Print ' . CATALOGNUMBERLABEL . 's' : (isset($LANG['PRINT_CAT_NUM']) ? $LANG['PRINT_CAT_NUM'] : 'Print Catalog Numbers')) ?> </span>
									</div>
									<?php
									if(class_exists('Image_Barcode2') || class_exists('Image_Barcode')){
										...
										<div class="fieldDiv">
											...
											<span class="checkboxLabel"><?php echo (defined('CATALOGNUMBERLABEL')? 'Include barcode of ' . CATALOGNUMBERLABEL: (isset($LANG['INCL_BARCODE']) ? $LANG['INCL_BARCODE'] : 'Include barcode of Catalog Number')) ?> </span>
										</div>
										<!--
										<div class="fieldDiv">
