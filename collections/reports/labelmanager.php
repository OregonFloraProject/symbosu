						...
						<div style="margin:3px;clear:both;">
							...
							<div style="margin-left:20px;float:left;">
								...
								<select name="datetarget" id="datetarget">
									...
									<option value="datelastmodified" <?= (isset($_REQUEST['datetarget']) && $_REQUEST['datetarget'] == 'datelastmodified'?'SELECTED':'') ?>><?= $LANG['DATE_MOD'] ?></option>
									<option value="eventdate"<?= (isset($_REQUEST['datetarget']) && $_REQUEST['datetarget'] == 'eventdate'?'SELECTED':'') ?>><?= $LANG['DATE_COLL'] ?></option>
								</select>
							</div>
						</div>
						<div style="margin:3px;clear:both;">
							<label for="labelproject"> <?= (defined('LABELPROJECTLABEL')?LABELPROJECTLABEL: (isset($LANG['LABEL_PROJ']) ? $LANG['LABEL_PROJ'] : 'Label Projects:')) ?></label>
							...
							<form name="selectform" id="selectform" action="labeldynamic.php" method="post" onsubmit="return validateSelectForm(this);">
								<table class="styledtable" style="font-size:12px;">
									<tr>
										...
										<th title="Label quantity"> <?= (isset($LANG['QTY']) ? $LANG['QTY'] : 'Qty') ?> </th>
										<th> <?= (defined('RECORDEDBYLABEL')?RECORDEDBYLABEL: (isset($LANG['COLLECTOR']) ? $LANG['COLLECTOR'] : 'Collector')) ?> </th>
										<th> <?= (defined('SCIENTIFICNAMELABEL')?SCIENTIFICNAMELABEL: (isset($LANG['SCI_NAME']) ? $LANG['SCI_NAME'] : ' Scientific Name')) ?></th>
										<th> <?= (defined('LOCALITYLABEL')?LOCALITYLABEL: (isset($LANG['LOCALITY']) ? $LANG['LOCALITY'] : 'Locality')) ?></th>
									</tr>
									<?php
									$trCnt = 0;
								...
								<fieldset style="margin-top:15px;">
									...
									<div class="fieldDiv">
										...
										<div class="fieldElement">
											<input type="radio" id="hmid1" name="hmid" value="1" /> <?= (defined('COUNTRYLABEL')?COUNTRYLABEL: (isset($LANG['COUNTRY']) ? $LANG['COUNTRY'] : 'Country')) ?>
											<input type="radio" id="hmid2" name="hmid" value="2" /> <?= (defined('STATEPROVINCELABEL')?STATEPROVINCELABEL: (isset($LANG['STATE']) ? $LANG['STATE'] : 'State')) ?>
											<input type="radio" id="hmid3" name="hmid" value="3" /> <?= (defined('COUNTYLABEL')?COUNTYLABEL: (isset($LANG['COUNTY']) ? $LANG['COUNTY'] : 'County')) ?>
											<input type="radio" id="hmid4" name="hmid" value="4" /> <?= (defined('FAMILYLABEL')?FAMILYLABEL: (isset($LANG['FAMILY']) ? $LANG['FAMILY'] : 'Family')) ?>
											<input type="radio" id="hmid0" name="hmid" value="0" checked/> <?= (isset($LANG['BLANK']) ? $LANG['BLANK'] : 'Blank') ?>
										</div>
									</div>
									<div class="fieldDiv">
									...
									<div class="fieldDiv">
										...
										<span class="checkboxLabel"><?= (defined('CATALOGNUMBERLABEL')?'Print ' . CATALOGNUMBERLABEL . 's' : (isset($LANG['PRINT_CAT_NUM']) ? $LANG['PRINT_CAT_NUM'] : 'Print Catalog Numbers')) ?> </span>
									</div>
									<?php
									if(class_exists('Image_Barcode2') || class_exists('Image_Barcode')){
										...
										<div class="fieldDiv">
											...
											<span class="checkboxLabel"><?= (defined('CATALOGNUMBERLABEL')? 'Include barcode of ' . CATALOGNUMBERLABEL: (isset($LANG['INCL_BARCODE']) ? $LANG['INCL_BARCODE'] : 'Include barcode of Catalog Number')) ?> </span>
										</div>
										<!--
										<div class="fieldDiv">
