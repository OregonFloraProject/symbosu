...
class OccurrenceLabel {
	...
	public function getLabelArray($occidArr, $speciesAuthors = false) {
		...
		if ($occidArr) {
			...
			if($speciesAuthors && $retArr[$occid]['infraspecificepithet'] != "" && $retArr[$occid]['scientificnameauthorship'] == $retArr[$occid]['parentauthor'] && preg_match('/.* '.$retArr[$occid]['infraspecificepithet']."/", $retArr[$occid]['speciesname'])) {
				$retArr[$occid]['scientificnameauthorship'] = "";
				$retArr[$occid]['scientificname_with_author'] = trim($labelArr[$occid]['speciesname'] . ' ' . trim($labelArr[$occid]['parentauthor'] . ' ' . $labelArr[$occid]['taxonrank']) . ' ' . $labelArr[$occid]['infraspecificepithet'] . ' ' . $labelArr[$occid]['scientificnameauthorship']);
			}
