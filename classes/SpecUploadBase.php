		...
		if($this->collId){
			if($this->uploadType == $this->FILEUPLOAD || $this->uploadType == $this->SKELETAL || $this->uploadType == $this->INATURALIST){
				...
				$sql = 'UPDATE IGNORE uploadspectemp u INNER JOIN omoccurrences o ON u.occid = o.occid
					...
					SET d.sciname = IFNULL(NULLIF(o.sciname, ""), "undetermined"), d.identifiedBy = IFNULL(NULLIF(o.identifiedBy, ""), IFNULL(NULLIF(o.recordedBy, ""), "Unknown")), d.dateIdentified = IFNULL(NULLIF(o.dateIdentified, ""), IFNULL(NULLIF(o.eventDate, ""), "0000-00-00")),
				...
				$sql = 'INSERT IGNORE INTO omoccurdeterminations(occid, sciname, identifiedBy, dateIdentified, family, scientificNameAuthorship, tidInterpreted, identificationQualifier,
					...
					SELECT o.occid, IFNULL(NULLIF(o.sciname, ""), "undetermined") AS sciname, IFNULL(NULLIF(o.identifiedBy, ""), IFNULL(NULLIF(o.recordedBy, ""), "Unknown")) AS identifiedBy, IFNULL(NULLIF(o.dateIdentified, ""), IFNULL(NULLIF(o.eventDate, ""), "0000-00-00")) AS dateIdentified,
