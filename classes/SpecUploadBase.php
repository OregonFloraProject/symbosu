		...
		if($this->collId){
			if($this->uploadType == $this->FILEUPLOAD || $this->uploadType == $this->SKELETAL){
				...
				$sql = 'UPDATE IGNORE uploadspectemp u INNER JOIN omoccurrences o ON u.occid = o.occid
					...
					SET d.sciname = IFNULL(o.sciname, "undetermined"), d.identifiedBy = IFNULL(o.identifiedBy, "Unknown"), d.dateIdentified = IFNULL(o.dateIdentified, "0000-00-00"),
				...
				$sql = 'INSERT IGNORE INTO omoccurdeterminations(occid, sciname, identifiedBy, dateIdentified, family, scientificNameAuthorship, tidInterpreted, identificationQualifier,
					...
					SELECT o.occid, IFNULL(o.sciname, "undetermined") AS sciname, IFNULL(o.identifiedBy, "Unknown") AS identifiedBy, IFNULL(o.dateIdentified, "0000-00-00") AS dateIdentified,
