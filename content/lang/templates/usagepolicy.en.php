...
$LANG['DATA_USAGE_GUIDELINES'] = 'Data Usage Guidelines';
$LANG['HOME'] = 'Home';
$LANG['GUIDE_ACCESSIBLE'] = 'Guidelines for Acceptable Use of Data';
$LANG['REC_CITATION'] = 'Recommended Citation Formats';
...
$LANG['NAME_INST_COLL'] = 'Oregon State University Vascular Plant Collection';
$LANG['NAME_INST_OCCUR'] = 'Name of Institution or Collection. Occurrence dataset';
$LANG['ACCESSED_VIA'] = 'accessed via the Fresh Symbiota Install Portal';
$LANG['GLOSSARY'] = 'Glossary';
$LANG['PLEASE_CITE'] = 'Please cite this portal\'s glossary as';
$LANG['RECORD_USE_POLICY'] = 'Occurrence Record Use Policy';
$LANG['OCC_REC_POLICY_1_1'] = 'While';
$LANG['OCC_REC_POLICY_1_2'] = 'will make every effort possible to control and document the quality
...
$LANG['IMAGES'] = 'Images';
$LANG['IMAGES_POLICY_1'] = 'Images within this website have been generously contributed by their owners to promote education and research. These contributors retain the full copyright for their images.
		Unless stated otherwise, images are made available under the Creative Commons Attribution-ShareAlike';
$LANG['IMAGES_POLICY_2'] = 'Users are allowed to copy, transmit, reuse, and/or adapt content, as long as attribution regarding the source of the content is made. If the content is altered, transformed,
		or enhanced, it may be re-distributed only under the same or similar license by which it was acquired.';
$LANG['NOTES_REC_IMG'] = 'Notes on Specimen Records and Images';
