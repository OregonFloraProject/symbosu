...
$LANG['ERROR_EDITING_IMAGE'] = 'ERROR editing media';
$LANG['IMAGE_ADD_SUCCESS'] = 'Media added successfully';
$LANG['IMAGE_DEL_SUCCESS'] = 'Media deleted successfully';
$LANG['IMAGE_REMAP_SUCCESS'] = 'SUCCESS: Media remapped to record';
$LANG['IMAGE_REMAP_ERROR'] = 'ERROR linking media to new specimen';
$LANG['NEW_IMAGE_ERROR'] = 'ERROR linking media to new blank specimen';
$LANG['DISASS_SUCCESS'] = 'SUCCESS disassociating media';
$LANG['DISASS_ERORR'] = 'ERROR disassociating media';
...
$LANG['LOCALITY_SECURITY_APPLIED'] = 'Locality Security applied';
$LANG['FULL_SECURITY_APPLIED'] = 'Full Security applied';
...
$LANG['CARRY_OVER_IMAGES'] = 'Carry over media';
...
$LANG['REMAIN_ON_PAGE'] = 'Remain on Editing Page (add media, determinations, etc)';
...
$LANG['ERROR_REMAPPING_IMAGES'] = 'ERROR remapping media';
...
$LANG['ERROR_ARCHIVING_IMG_HISTORY'] = 'ERROR - Archiving Media history';
$LANG['ERROR_DELETING_IMGS'] = 'ERROR - Deleting Media';
