...
$LANG['GUIDE_TWO'] = 'Tenga en cuenta que los términos de uso adicionales específicos de las colecciones individuales pueden distribuirse con la descarga de datos. Cuando están presentes, los términos
                         proporcionadas por la institución propietaria deben prevalecer sobre las condiciones generales publicadas en el sitio web.';
...
$LANG['SYMB_NATIVE_INFO'] = 'Symbiota Native es muy similar a Darwin Core excepto por la adición de algunos campos
                         como sustrato, coleccionistas asociados, descripción textual.';
