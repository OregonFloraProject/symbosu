...
$LANG['RETRIEVE_RESET_MSG'] = 'If a valid account is found, an email with your information will be sent shortly. If a password reset message does not appear in your inbox soon, check your spam/junk folder. Contact an administrator if you do not receive it.';
...
$LANG['PORTAL_LOGIN'] = 'OregonFlora Login';
