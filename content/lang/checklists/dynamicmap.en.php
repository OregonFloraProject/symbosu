...
$LANG['CHECKLIST_GENERATOR'] = 'Identify Plants';
...
$LANG['MORE_DETAILS'] = '[more]';
//$LANG['MORE_DETAILS'] = 'More Details';
$LANG['RADIUS_DESCRIPTION'] = 'You can filter results to a single plant family using the dropdown below. 
					Entering a radius is optional. If a radius is not supplied, the area is sampled in concentric rings until the sample size
					 is determined to best represent the local species diversity. Therefore, poorly collected areas will have a larger radius 
					 sampled.';
...
$LANG['TAXON_FILTER'] = 'Higher Taxon Filter';
