...
<div class="navpath">
	...
	<a href="checklist.php?clid=<?php echo htmlspecialchars($clid, ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . ($pid != '' ? '&pid=' . htmlspecialchars($pid, ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) : ''); ?>"><?php echo htmlspecialchars($LANG['RETURNCHECK'], ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE);?></a> &gt;&gt;
...
<div class="voucher-admin-header">
	<a href="checklist.php?clid=<?php echo htmlspecialchars($clid, ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . ($pid != '' ? '&pid=' . htmlspecialchars($pid, ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) : ''); ?>">
