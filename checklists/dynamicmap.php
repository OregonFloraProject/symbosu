				...
				<form name="mapForm" action="dynamicchecklist.php" method="post" onsubmit="return checkForm();" class="flex-form">
					<div class="flex-form">
						...
						<div style="margin-left: 0;">
							...
							<input name="radius" id="radius" placeholder="(optional)" type="text" style="width:140px;" onfocus="this.value = ''" />
					...
					<div>
						...
						<input type="submit" name="buildchecklistbutton" value="<?php echo $LANG['BUILD_CHECKLIST']; ?>" disabled class="btn-primary"/>
					</div>
